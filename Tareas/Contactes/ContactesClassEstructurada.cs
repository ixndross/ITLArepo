            ...
            while (runing)
            {
                try
                {
                    ...
                    switch (typeOption)
                    {
                        case 1:
                            {
                                Helpers.AddContact(Contactos);

                            }
                            break;
                        case 2:
                            {
                                Helpers.ShowContacts(Contactos);
                            }
                            break;
                        case 3:
                            {
                                Helpers.SearchContacts(Contactos);
                            }
                            break;
                        case 4:
                            {
                                Helpers.ModifyContacts(Contactos);
                            }
                            break;
                        case 5:
                            {
                                Helpers.DeleteContacts(Contactos);
                            }
                            break;
                        case 6:
                            {
                ...
                {
                    Console.WriteLine("El programa ha encontrado un error en la ejecucion del programa. Por favor, intente mas tarde. " + ex.Message);
                }
            }
        }
    }
